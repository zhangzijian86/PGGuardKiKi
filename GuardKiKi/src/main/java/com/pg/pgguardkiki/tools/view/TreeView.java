package com.pg.pgguardkiki.tools.view;
...
public class TreeView extends ExpandableListView implements
	 ...
	 */
	public interface TreeHeaderAdapter {
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		mAdapter = (TreeHeaderAdapter) adapter;
	}
